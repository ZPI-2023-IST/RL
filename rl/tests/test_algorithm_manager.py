...
class TestAlgorithmManager(unittest.TestCase):
    def test_decorator(self):
        ...
        self.assertTrue(TestAlgorithm in algorithm_manager.registered_algorithms.values())
        self.assertTrue("TestAlgorithm" in algorithm_manager.registered_algorithms.keys())
        self.assertTrue(algorithm_manager.registered_algorithms["TestAlgorithm"] is TestAlgorithm)
